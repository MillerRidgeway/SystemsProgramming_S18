...
void ThreadWorker(SharedQueue<Range> *workQueue, SharedQueue<uint64_t> *resultQueue) {
    ...
    while (true) {
        ...
        while (workQueue->Remove(r) == false) { std::this_thread::yield(); }
 ...
 * Finding perfect numbers from 1 to 10000 took 0.211054 seconds.
    1 threads; work unit 10000 items.
 *
 * Finding perfect numbers from 1 to 10000 took 0.267051 seconds.
    1 threads; work unit 1 items.
 *
 * Finding perfect numbers from 1 to 10000 took 0.114257 seconds.
    4 threads; work unit 1 items.
 *
 * Finding perfect numbers from 1 to 10000 took 0.0589902 seconds.
    4 threads; work unit 100 items.
 *
 * Finding perfect numbers from 1 to 100000 took 6.5755 seconds.
    4 threads; work unit 100 items.
 *
 *    The number of threads and the work unit greatly influence the time in which a task runs.
      If your work unit is too small - like 1 - the thread locking and unlocking cause a slowdown.
      But, if your work unit is the right size - like 100 - the parallel processing time is faster
      despite the locking and unlocking of threads.
 */
